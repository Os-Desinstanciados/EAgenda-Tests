...
namespace eAgenda.Infra.Compartilhado.Orm.Migrations
{
    ...
    [Migration("20260902154251_Add_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eAgenda.Dominio.Modulos.ModuloDespesa.Despesa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eAgenda.Dominio.Modulos.ModuloInstituicao.Instituicao", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eAgenda.Dominio.Modulos.ModuloTarefa.ItemTarefa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eAgenda.Dominio.Modulos.ModuloTarefa.Tarefa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TBDespesaCategoria", b =>
                {
                    b.HasOne("eAgenda.Dominio.Modulos.ModuloCategoria.Categoria", null)
                        .WithMany()
                        .HasForeignKey("CategoriasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eAgenda.Dominio.Modulos.ModuloDespesa.Despesa", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eAgenda.Dominio.Modulos.ModuloInstituicao.Instituicao", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser<System.Guid>", null)
                        .WithOne()
                        .HasForeignKey("eAgenda.Dominio.Modulos.ModuloInstituicao.Instituicao", "UserId")
            ...
            modelBuilder.Entity("eAgenda.Dominio.Modulos.ModuloTarefa.ItemTarefa", b =>
                {
                    b.HasOne("eAgenda.Dominio.Modulos.ModuloTarefa.Tarefa", null)
                        .WithMany("Itens")
